...
public class StateAdapter extends RecyclerView.Adapter<StateAdapter.ViewHolder> {
    ...
    public  StateAdapter(Context context,ArrayList<StateModel> states){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.statelviserow,parent,false);
       ...
       String curstate = states.get(position).getStates();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(context, Statewise.class);
